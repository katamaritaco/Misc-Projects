 ...
 */
public class Hook extends GetterEffect {
	...
	public Hook(Point src, Point tgt){
...
//			System.out.println(list.size());
			...
			if(!hasReversed && distanceTraveled > 350.0f){
				reverseDirection();
			}
		}else{
	...
	private void reverseDirection(){
		...
		float oldDY = dy;
		Player player = RSP.getPlayer();
		dx = (float)(-((this.getX()-player.getX()) / Maths.dist(this, player)) * (speed/2.0f));
		dy = (float)(-((this.getY()-player.getY()) / Maths.dist(this, player)) * (speed/2.0f));
